  ...
  <div class="card">
    <div class="card-body pb-0">
      <div class="text-center mt-3">
        ...
        <h5 class="mt-2 mb-0">asd</h5>
        <h6 class="text-muted font-weight-normal mt-2 mb-4">User Experience Specialist</h6>
        ...
        <div class="mt-4 pt-3 border-top text-left">
          ...
          <p class="mb-2">
            ...
            <label class="badge badge-soft-success ml-1">Frontend Development</label>
          </p>
        </div>
      </div>
    </div>
