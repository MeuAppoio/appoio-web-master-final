      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="sub-header">
              Use
              <code>.table-striped</code> to add zebra-striping to any table row
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="sub-header">
              Add
              <code class="highlighter-rouge">.table-bordered</code> for borders
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="sub-header">
              Add
              <code>.table-hover</code> to enable a hover state on table rows
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="sub-header">
              Add
              <code>.table-sm</code> to make tables more compact by cutting cell
              padding in half.
            </p>
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="sub-header">
              A
              <code>&lt;caption&gt;</code> functions like a heading for a table.
